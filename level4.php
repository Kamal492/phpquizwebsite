...
<html lang="en" dir="ltr">
  ...
  <div class="logout-div">
    ...
    <input type="submit"  class="level-output" value="Logout" name="logout_4"></input>
    </form>
</div>
   <h1>Level 4</h1>
   <div class="q_set">
...
<form method="post" action="checkanswer.php">
    ...
    ?>
    <div class="btn-div" >
     <input type="submit" onclick="Change()" class="submit-btn" id="submit-b" name="submit-4_<?php echo $i?>" value="Submit">
    </div>
    </form>
    </div>
